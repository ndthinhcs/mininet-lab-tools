        ...
        for tcp_stream_id in range(tcp_stream_count):
            ...
            for packet_index in range(PACKET_PER_FLOW):
                try: 
                    ...
                    print(e)
                    print(f'TCP stream: {tcp_stream_id}, PKT_ID: {packet_index} - Error')
            capture_tcp.close()
            del capture_tcp
        ...
        for udp_stream_id in range(udp_stream_count):
            ...
            for packet_index in range(PACKET_PER_FLOW):
                try:
                    ...
                    # print(f'''UDP stream: {udp_stream_id}, PKT_ID: {packet_index} - Stream ended''')
                    break
                except Exception as e:
                    print(e)
                    print(f'UDP stream: {udp_stream_id}, PKT_ID: {packet_index} - Error')
            capture_udp.close()
            del capture_udp
